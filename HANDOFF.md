...
- 分支：`main`
- 已推送本地提交
- Release：`v1.0.1`（v1.0.0 仍保留）（https://github.com/HoshiGT/LiteSchedule-Android/releases/tag/v1.0.0）
...
- `/home/hoshi/Kebiao/qingkebiao_v0.1.apk`
  ...
  - 功能：
    ...
    - 课表空白处点击会出现临时“+”气泡，上下拖动调整节数，松手进入新增课程页；新增课程支持名称、颜色、周次、节次、教师、教室、备注
    - 小组件已显示日期、周次/星期、右上箭头，点击进入 App
    - 教务 WebView 已启用电脑版 User-Agent + 宽视口 + 双指缩放；打开后自动隐藏网址控制栏，可在顶部“设置网址”切回
    - 设置入口改为顶部齿轮；新增“赞赏 1 元解锁自定义背景”（微信赞赏二维码 + 设备码兑换激活码 + 预设背景切换 + 相册导入图片）
    - 设置页“开源仓库”跳转 GitHub，入口“赞赏支持”跳转 `https://schedule.hoshichan.moe`
